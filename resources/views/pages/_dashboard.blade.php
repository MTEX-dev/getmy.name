...
@section('content')
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Welcome Card -->
                <div class="md:col-span-2 bg-gradient-to-br from-getmyname-600 to-getmyname-800 rounded-2xl shadow-lg p-6 text-white relative overflow-hidden group">
                    ...
                    <div class="relative z-10 flex flex-col justify-between h-full">
                        <div>
                            ...
                            <p class="text-getmyname-100 mt-1 font-mono text-sm">{{ '@' . auth()->user()->username }}</p>
                        </div>
                ...
                <!-- API Counter Card -->
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 flex flex-col justify-center items-center text-center relative overflow-hidden">
                    <div class="absolute inset-0 bg-getmyname-50 dark:bg-getmyname-900/10 opacity-50"></div>
                    <div class="relative z-10">
                        <div class="inline-flex p-3 rounded-full bg-getmyname-100 dark:bg-getmyname-900/50 text-getmyname-600 dark:text-getmyname-400 mb-3">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                        </div>
                        <h4 class="text-gray-500 dark:text-gray-400 text-sm font-medium uppercase tracking-wider">{{ __('Total API Requests') }}</h4>
                        <p class="text-4xl font-bold text-gray-900 dark:text-gray-100 mt-2">{{ number_format(auth()->user()->getApiRequestCount()) }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-2xl border border-gray-100 dark:border-gray-700">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                    ...
                    <span class="text-xs font-medium px-2.5 py-0.5 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300">
                        {{ __('Last :days days', ['days' => $days]) }}
                    </span>
                </div>
                <div class="p-6">
    ...
    <script>
        ...
        // Brand Colors
        const primaryColor = '#22c55e'; // getmyname-500
            ...
            options: {
                ...
                scales: {
                    x: {
                        ...
                        grid: { color: 'transparent' } // Hide x-grid for cleaner look
                    },
                    y: {
                        beginAtZero: true,
