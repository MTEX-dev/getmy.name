<section id="get-started" class="bg-white dark:bg-gray-800 py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="relative isolate overflow-hidden bg-gray-900 dark:bg-gimysite-900 px-6 py-24 shadow-2xl rounded-3xl sm:px-24 xl:py-32">
            ...
            <p class="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300 dark:text-gimysite-200">
            ...
            <div class="mx-auto mt-10 flex max-w-md items-center justify-center gap-x-6">
                ...
                <a href="https://mtex.dev" target="_blank" class="text-sm font-semibold leading-6 text-white dark:text-gimysite-100">
