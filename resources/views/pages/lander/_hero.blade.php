    ...
    <div class="mx-auto max-w-7xl px-6 pt-12 pb-36 sm:pt-20 sm:pb-44 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">
                Your Developer-First Portfolio API. Seamlessly manage and share your personal information and portfolio data through a robust and secure API endpoint.
            </p>
            <p class="mt-4 text-md leading-7 text-gray-500 dark:text-gray-500">
                Crafted by the innovative minds at <a href="https://mtex.dev" target="_blank" class="text-indigo-600 dark:text-indigo-400 hover:underline">mtex.dev</a>.
            </p>
