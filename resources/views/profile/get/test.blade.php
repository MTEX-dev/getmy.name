...
<head>
    ...
    @php
        ...
        // Safely get a social handle without protocol or @
    ...
    <style>
        ...
        .theme-btn { padding: .45rem .6rem; border-radius: .5rem; display:inline-flex; align-items:center; justify-content:center; }
        .theme-btn.active { background: linear-gradient(135deg,#3b82f6,#9333ea); color: #fff; border: 2px solid transparent; }
...
<body class="font-inter bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 text-gray-900 dark:text-white transition-all duration-500">
        ...
        <nav role="navigation" class="fixed top-0 left-0 right-0 z-50 floating-card border-b border-white/20 dark:border-gray-700/30" style="height:var(--nav-height);" x-data="{ mobileOpen: false }">
            <div class="max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <div class="flex bg-white/50 dark:bg-gray-800/50 rounded-lg p-1 backdrop-blur-sm" role="tablist" aria-label="Theme switcher">
    ...
    {{-- themeManager must be defined BEFORE Alpine initializes --}}
    <script>
                ...
                initSmoothScroll() {
                    document.querySelectorAll('a[href^="#"]').forEach(anchor => {
                        anchor.addEventListener('click', function (e) {
                            // If link points to top (#top) or valid target, smooth scroll
                            ...
                            if (target) {
                                ...
                                // if mobile nav open, try to close it (Alpine scope)
                                try { if (document.querySelector('[x-data]') && window.Alpine) { /* nothing here; mobile close handled by Alpine */ } } catch(e) {}
                            }
                        });
                    });
                }
