...
>
    ...
    <div class="flex-1 flex pt-16 relative">
        ...
        >
            ...
            <!-- Nav Items -->
            <!-- Note: overflow-y-auto is removed when collapsed so tooltips can popup -->
            <nav 
            ...
            >
                @php
                    $menuItems = [
                        ...
                        ['route' => 'profile.education', 'label' => __('profile.education'), 'icon' => 'M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z'],
                        ['route' => 'profile.experiences', 'label' => __('profile.experiences.title'), 'icon' => 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'],
